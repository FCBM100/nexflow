    ...
    <footer ref={footerRef} className="border-t border-white/5">
      <div className="container-narrow px-4 py-12 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          {/* Services */}
          <div className="footer-col">
            <h4 className="text-sm text-white font-semibold mb-4">الخدمات</h4>
            <ul className="space-y-2">
              <li className="text-body-sm text-body/60">تطوير مواقع</li>
              <li className="text-body-sm text-body/60">بوتات ذكية</li>
              <li className="text-body-sm text-body/60">أتمتة العمليات</li>
            </ul>
          </div>
